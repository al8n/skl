...
pub mod sync {
  pub use crate::sync::trailed::{AllVersionsIter, AllVersionsRange, Entry, Iter, Range, SkipMap};
}

/// [`TrailedMap`] implementation for non-concurrent environment.
pub mod unsync {
  pub use crate::unsync::trailed::{
    AllVersionsIter, AllVersionsRange, Entry, Iter, Range, SkipMap,
  };
}
  ...
  <Self::Allocator as AllocatorSealed>::Node: WithTrailer,
{
  ...
  ///
  /// ```rust
  /// use skl::{trailed::{unsync::SkipMap, TrailedMap}, ValueBuilder, Options};
  ///
  /// struct Person {
  ///   id: u32,
  ///   name: String,
  ...
  ///
  /// ```rust
  /// use skl::{trailed::{unsync::SkipMap, TrailedMap}, ValueBuilder, Options, Arena};
  ///
  /// struct Person {
  ///   id: u32,
  ///   name: String,
  ...
  ///
  /// ```rust
  /// use skl::{trailed::{unsync::SkipMap, TrailedMap}, KeyBuilder, ValueBuilder, Options};
  ///
  /// struct Person {
  ///   id: u32,
  ///   name: String,
  ...
  ///
  /// ```rust
  /// use skl::{trailed::{unsync::SkipMap, TrailedMap}, KeyBuilder, ValueBuilder, Options, Arena};
  ///
  /// struct Person {
  ///   id: u32,
  ///   name: String,
