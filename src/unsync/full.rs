...
impl<T: Trailer, C> SkipMap<T, C> {
  ...
  ///
  /// ```rust
  /// use skl::{unsync::full::SkipMap, Options, Ascend};
  ///
...
impl<T: Trailer, C: Comparator> SkipMap<T, C> {
  ...
  ///
  /// ```rust
  /// use skl::{unsync::full::SkipMap, Options};
  ///
  /// let map = SkipMap::new(Options::new()).unwrap();
  ///
...
impl<T: Trailer, C: Comparator> SkipMap<T, C> {
  ...
  ///
  /// ```rust
  /// use skl::{unsync::full::SkipMap, ValueBuilder, Options};
  ///
  /// struct Person {
  ///   id: u32,
  ///   name: String,
  ...
  ///
  /// ```rust
  /// use skl::{unsync::full::SkipMap, KeyBuilder, ValueBuilder, Options};
  ///
  /// struct Person {
  ///   id: u32,
  ///   name: String,
  ...
  ///
  /// ```rust
  /// use skl::{unsync::full::SkipMap, KeyBuilder, Options};
  ///
  /// struct Person {
  ///   id: u32,
  ///   name: String,
