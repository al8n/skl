  ...
  <M::Allocator as Sealed>::Node: WithVersion,
{
  ...
  let l2 = M::create_from_allocator(l.allocator().clone(), crate::generic::Ascend::new()).unwrap();
  ...
  <M::Allocator as Sealed>::Node: WithVersion,
{
  ...
  let mut ent = l.first_with_tombstone(MIN_VERSION + 1);
  let mut i = 0;
  while let Some(ref entry) = ent {
    if i % 2 == 1 {
  ...
  <M::Allocator as Sealed>::Node: WithVersion,
{
  ...
  let mut ent = l.last_with_tombstone(MIN_VERSION + 1);
  let mut i = 0;
  while let Some(ref entry) = ent {
    if i % 2 == 0 {
      assert_eq!(entry.version(), MIN_VERSION);
  ...
  unsafe {
    ...
    let header = {
      let l = Builder::new()
        ...
        .unwrap();
      let l2 =
        M::create_from_allocator(l.allocator().clone(), crate::generic::Ascend::new()).unwrap();
    ...
    let l = Builder::new()
      ...
      .unwrap();
    let l2 =
      M::open_from_allocator(header, l.allocator().clone(), crate::generic::Ascend::new()).unwrap();
    assert_eq!(500, l.len());
  ...
  <M::Allocator as Sealed>::Node: WithVersion,
{
  ...
  for i in 100..150 {
    let k = key(i);
    let ent = l.get_with_tombstone(MIN_VERSION, k.as_slice()).unwrap();
    assert_eq!(ent.key(), k.as_slice());
...
macro_rules! __generic_multiple_version_map_tests {
  ($prefix:literal: $ty:ty) => {
    $crate::__unit_tests!($crate::tests::generic::multiple_version |$prefix, $ty, $crate::tests::generic::TEST_OPTIONS| {
      empty,
      basic,
      #[cfg(not(miri))]
      basic_large,
    ...
    $crate::__unit_tests!($crate::tests::generic::multiple_version |$prefix, $ty, $crate::tests::generic::TEST_FULL_OPTIONS| {
      full,
    });
    ...
    fn reopen() {
      $crate::tests::generic::multiple_version::reopen_mmap::<$ty>($prefix);
    }
    ...
    #[allow(clippy::macro_metavars_in_unsafe)]
    fn reopen2() {
      $crate::tests::generic::multiple_version::reopen_mmap2::<$ty>($prefix);
    }
    ...
    #[allow(clippy::macro_metavars_in_unsafe)]
    fn reopen3() {
      $crate::tests::generic::multiple_version::reopen_mmap3::<$ty>($prefix);
    }
  };
  // Support from golang :)
  (go $prefix:literal: $ty:ty => $opts:path) => {
    $crate::__unit_tests!($crate::tests::generic::multiple_version |$prefix, $ty, $opts| {
      #[cfg(feature = "std")]
    ...
    #[allow(clippy::macro_metavars_in_unsafe)]
    fn reopen4() {
      $crate::tests::generic::multiple_version::reopen_mmap4::<$ty>($prefix);
    }
    ...
    $crate::__unit_tests!($crate::tests::generic::multiple_version |$prefix, $ty, $crate::tests::generic::BIG_TEST_OPTIONS| {
